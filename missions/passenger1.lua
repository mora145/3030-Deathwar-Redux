...
function prototype()
	...
	if people ~= 1 then		
		...
		-- one person only
		t3[1]="Need transport to ".. dropOffSystem.."."
		t3[2]="I would like passage to the " .. dropOffSystem.." system."
		t3[3]="Can you take me to the ".. dropOffSystem.. " system?"
		t3[4]="I'm looking for a transport to "..dropOffSystem.."."
		t3[5]="I am in need of a ship to the "..dropOffSystem.." system."
		t3[6]="Passage required to the "..dropOffSystem.." system."
		t3[7]="Please take me to "..dropOffSystem.."."
		t3[8]="I desperately need to get to the "..dropOffSystem.." system."
