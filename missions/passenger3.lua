...
function prototype()
	...
	if people ~= 1 then
		...
		t3[1]="Necesitamos transportar "..people.." personas a la estación ".. dropOffStation.."."
		t3[2]="A "..people.." personas les gustarían poder llegar a la estación " .. dropOffStation.."."
		t3[3]="¿Puedes llevar a nuestro grupo de "..people.." personas a la estación ".. dropOffStation.. "?"
		t3[4]="Nuestras "..people.." personas están buscando un transporte a la estación "..dropOffStation.."."
		...
		t3[7]="Por favor, llévese "..people.." personas nuestras a la estación "..dropOffStation.."."
	else
		-- one person only
